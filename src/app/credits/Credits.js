    ...
    <section id="credits">
      ...
      <ul>
        ...
        <li>
          ...
          YouTube, YouTube, 23 Sept. 2013, www.youtube.com/watch?v=hFAOXdXZ5TM.
        </li>
        <li>
          “U.S. Energy Information Administration - EIA - Independent Statistics
          and Analysis.” How Electricity Is Generated - U.S. Energy Information
          Administration (EIA),
        ...
        <li>
          Woodford, Chris. “Magnetism for Kids - A Simple Introduction.” Explain
          That Stuff, 25 Oct. 2019, www.explainthatstuff.com/magnetism.html.
        </li>
      </ul>
      <h2>About</h2>
      <p>
        This is a school project designed to help incoming physics students to
        learn about the concept of the generation of electricity in a genralized
        manner.
      </p>
      <p>
        This was developed by Kevin Gao and is coded using HTML, CSS, Javascript
        and React.js
      </p>
    </section>
  );
